user = User.create(email: "macrodynamo@gmail.com", password: "2Einsteins", role: 3)

user2 = User.create(email: "darrenbrogden@me.com", password: "315Riverside", role: 3)

user3 = User.create(email: "kirsten@worldmacro.us", password: "2Einsteins", role: "admin")
